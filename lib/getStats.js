module.exports = (db, cb) => {
  var result = {}
  db.sequelize.query('SELECT crnStatuses.className,count(*) FROM crns,crnStatuses WHERE crns.crn = crnStatuses.crn GROUP BY crnStatuses.className HAVING count(*) > 2 ORDER BY count(*) DESC;').then(function(data) {
