...
module.exports = async (db, io, browser, cb) => {
					...
					for (const sem of semestersArr) {
						...
						try {
							...
							for (const crn of crns) {
								...
								await page.waitForSelector(`tr a[href="/axp3b21h/owa/bwckschd.p_disp_detail_sched?term_in=${sem}&crn_in=${crn.crn}"]`).catch(async err => {
